...
2.  reshape from wide to long to please `ggplot`: we will talk about ggplot more in the future, for now, we can treat it as a blackbox that produces nice visualizations.
...
We now want to know which bigram is most characteristic of "Text A" (*The Circle of Commerce*) *reliative to* "Text B" (*Free Trade*).
