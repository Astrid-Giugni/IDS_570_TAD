...
⚠️ **Note of warning:** gensim may look “stuck” the first time. When you import `gensim` (especially on Windows), Python may appear to freeze for 10–60 seconds. This is normal and does **not** mean your code is broken.
