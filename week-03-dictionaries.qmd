...
text_tbl <- tibble(   doc_title = "The Circle of Commerce",   text = circle_raw )  
text_tbl
```
...
text_tbl <- text_tbl %>%   
  mutate(     text_clean = str_replace_all(text_original, "ſ", "s")   )  #str_view(text_tbl$text_original, "ſ") 
...
```{r}
name_map <- c(   "Smythe" = "Smith",   "Smyth"  = "Smith",   "Smithe" = "Smith" )
```
